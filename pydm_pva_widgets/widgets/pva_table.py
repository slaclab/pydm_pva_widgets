...
class NTTable(QtWidgets.QWidget, PyDMWidget):
    def __init__(self, parent=None, init_channel=None):
        super(NTTable, self).__init__(parent=parent, init_channel=init_channel)
    ...
    def _receive_data(self, data=None, introspection=None, *args, **kwargs):
        super(NTTable, self)._receive_data(data, introspection, *args,
                                           **kwargs)
        if data is None:
            return
